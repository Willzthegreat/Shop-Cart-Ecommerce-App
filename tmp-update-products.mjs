...
import connectDB from './lib/mongodb/mongodb.ts';
import Product from './models/product.ts';
import Category from './models/categoryType.ts';
import Brand from './models/brandType.ts';
import { products } from './components/productArray.tsx';
