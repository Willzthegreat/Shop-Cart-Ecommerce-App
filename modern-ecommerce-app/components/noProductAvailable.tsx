...
const NoProductAvailable = ({
    ...
    return (
      <div className={cn("flex flex-col items-center justify-center py-10 min-h-80 space-y-4", className)}>
        <motion.div
        ...
        <motion.div
            ...
            className="text-shop-dark-green flex items-center space-x-2"
          >
